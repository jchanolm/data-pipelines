...
import logging
import os
from pipelines.helpers.base import Base

# This class is the base class for all extractors (i.e. scrapers).
# Every extractor (scraper) must inherit this class and define its own run function
...
class Extractor(Base):
    def __init__(self, bucket_name, load_data=False):
        Base.__init__(self, bucket_name=bucket_name, metadata_filename="scraper_metadata.json", load_data=load_data)
